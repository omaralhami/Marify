[PSCustomObject]@{
    Welcome         = "\n╔══════════════════════════════════════════╗\n║ Добро пожаловать в Marify Pro для Windows ║\n╚══════════════════════════════════════════╝"
    ...
    NewV2           = "Ваша версия Spotify ({0}) не тестировалась. Стабильная версия для Marify Pro — {1}"
    ...
    Spicetify       = "Обнаружен Spicetify, он должен быть установлен после Marify Pro, открыть рекомендуемые действия в FAQ ? [Y/N]"
    NoRestore       = "Marify Pro уже установлен, xpui.bak не найден. `nПожалуйста, удалите клиент Spotify и снова запустите Install.bat"
